...
<body id="top-page">
        ...
        <div class="container-fluid div-main">
            ...
            <div class="row mt-4">
                <div class="col-11 mx-auto ">
                    <form id="form_pay" method="post" action="/admin/admin_order_pay_edit_update">

                        <input type="hidden" id="id_order" name="id_order_pay" value="<?= $id ?>">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input name="date" type="date" class="form-control" id="inputDate" placeholder="" required
                                        value="<?= strftime("%Y-%d-%m", strtotime($rs['date'])) ?>">
                                </div>
                            </div>
                        ...
                        <div class="row d-flex justify-content-between mt-4">
                            ...
                            <div class="col-6">
                                <a id="eliminate_order" href="/admin/client_order_pay_eliminate/<?= $rs['id'] ?>" class="form-control btn btn-danger">Eliminar</a>
                            </div>
    ...
    <script src="/public/js/admin_client_pay.min.js"></script>
